$("#add").click ->
  $("#roomIds")
    .append('<div class="room"><input type="text" size="20" placeholder="cw_r1234567"><button class="remove">-</button>')
  ...
  chrome.runtime.sendMessage { mode: "loadOptions" }, (response) ->
    ...
    if options && options.excludeRooms
      $.each options.excludeRooms, (_, room) ->
        $("#roomIds")
          .append('<div class="room"><input type="text" size="20" placeholder="cw_r1234567" value="' + room + '"><button class="remove">-</button>')
